...
(int32_t sub_type, int32_t msg_id, int64_t from_group, int64_t from_qq, const char *from_anonymous, const char *msg,
 int32_t font) {
    ...
    e.message_id = msg_id;
    e.raw_message = msg;
    // e.message = .raw_message; // moved to the bottom
    e.font = font;
    e.user_id = from_qq;
...
(int32_t sub_type, int32_t send_time, int64_t from_group, int64_t from_qq, 
	int64_t being_operate_qq, int64_t duration) {
...
(int32_t sub_type, int32_t send_time, int64_t from_group, int64_t from_qq, const char *msg, 
